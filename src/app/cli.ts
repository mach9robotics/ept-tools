    ...
    .command(
      ...
      (yargs) =>
        yargs
          ...
          .option('replace', {
            describe: 'Use REPLACE as the refinement strategy',
            default: false,
            type: 'boolean',
          }),
      ({
        ...
        const options = { dimensions, zOffset, truncate, replace }
        ...
        if (replace) console.log('Using REPLACE refinement strategy')
